...
Eleison har også tilpasset [Luthers kirkepostille](https://kirkepostille.vercel.app){target="_blank" .text-blue-500 .hover:text-blue-600 .transition-colors .duration-300} for mobil og nettbrett. Se også link øverst på forsiden og i menyen `Luther`.
::::
