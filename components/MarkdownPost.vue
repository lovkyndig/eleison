...
showTime = appConfig.basic.articlePage.showTime
...
showOutdatedWarningComponent = appConfig.basic.articlePage.outdated.show
...
const articleDOM = ref<HTMLElement | any>(null) // get the article DOM
...
const detailNodeArr = ref<any | NodeListOf<HTMLDetailsElement>>(null)
