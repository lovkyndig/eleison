...
- "Apper skal ha personvernregler selv om de ikke har tilgang til personlige og sensitive brukerdata."
Sitat (paa norsk) fra de nodvendige regelkravene i "Google Play Console". Engelsk version:
...
- Utvikleren har tilgang til denne informasjonen via hans utviklerkonto paa Google, som er verifisert ved eierskap til domenet hvor PWA er utplassert (se #### Url nedenfor).
...
Dersom du har sporsmaal eller innsigelser til at utvikleren benytter seg av Googles anonymiserte opplysninger om brukeraktivitet av nevnte app og pwa, 
kan sendes paa email:
...
### Om appen
#### Url
Appen er tilknyttet en pwa (via twa) som er utplassert Vercel paa folgende url:
